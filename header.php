			...
			<div class="barra">
				...
				<div class="socialicons">
					<ul>
						...
						<li class="facebook">
							<a target="_blank" href="<?php echo get_option('gife-facebook') ?>" taget="_blank"></a>
						</li>
						<?php endif; ?>

						<?php if ( get_option('gife-twitter') ): ?>
						<li class="twitter">
							<a target="_blank" href="http://twitter.com/<?php echo str_replace('@','',get_option('gife-twitter')) ?>" taget="_blank"></a>
						</li>
						<?php endif; ?>

						<?php if ( get_option('gife-orkut') ): ?>
						<li class="orkut">
							<a target="_blank" href="<?php echo get_option('gife-orkut') ?>" taget="_blank"></a>
						</li>
						<?php endif; ?>
					</ul>
				</div>
